...
| **US18** | Registro básico de estacionamiento | Como propietario quiero registrar mi estacionamiento para ofrecerlo en la plataforma | **Escenario 1: Registro exitoso con validación automática**<br>**Given** que un propietario completa datos básicos del estacionamiento (nombre, dirección, descripción)<br>**When** envía la información de registro<br>**Then** el estacionamiento aparece disponible para conductores después de validación automática<br><br>**Escenario 2: Configuración de precios y horarios**<br>**Given** que un propietario configura precio base y horarios de operación<br>**When** guarda la configuración inicial<br>**Then** las tarifas se aplican automáticamente a todas las nuevas reservas | **EP05** |
...
| 6 | TS01 | API de autenticación básica | Endpoints auth (login/register, JWT, refresh) | 5 |
| 7 | US06 | Perfil básico de conductor | Gestión de datos personales y vehículo | 3 |
| 8 | US07 | Perfil básico de propietario | Gestión de información comercial y contacto | 3 |
| 9 | US08 | Búsqueda simple de estacionamientos en mapa | Ver estacionamientos disponibles en mapa | 5 |
| 10 | US09 | Reserva básica con confirmación | Reservar espacio, procesar pago y recibir código QR | 5 |
| 11 | TS03 | API básica de reservas | Endpoints para crear/consultar reservas y devolución de QR | 5 |
| 12 | US10 | Historial básico de reservas | Ver reservas pasadas con filtros y detalles | 3 |
...
| 20 | US18 | Registro básico de estacionamiento | Propietario registra su estacionamiento en la plataforma | 5 |
...
| 24 | US21 | Modelo de comisiones básico | Desglose de comisiones por transacción para propietarios | 2 |
